...
class ItemPreviewAdapter(val fragment: Fragment, val itemPreview: ArrayList<Item>): RecyclerView.Adapter<ItemPreviewAdapter.ItemPreviewViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemPreviewViewHolder, position: Int) {
        holder.bind(itemPreview[position])
    }
    ...
    inner class ItemPreviewViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind(item: Item){
            ...
            // If the item is not completed, the checkbox is unchecked and the text is plain
            }else{
                listItem.apply{
                    isChecked = false
